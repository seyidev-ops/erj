...
- `config.js`: the event date (plus a short form for the Zoom cover), time, registration URL and CTA label. Set them here once. You can also override them with URL params `?date=&short=&time=&url=&cta=`.
...
NODE_PATH="$(npm root -g)" node export.mjs --date "Sunday, 27 September 2026" --short-date "Sun, 27 Sep 2026" --time "7:00 PM WAT" --url "everythingremotejob.com/launch"
```
